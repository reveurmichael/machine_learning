...
class MLPAgent:
    ...
    def get_move(self, game: Any) -> Optional[str]:
        # If a trained model exists, you would extract features and predict here.
        # For now, fallback to a safe heuristic that avoids reversal and heads toward the apple.
