...
- **Dataset consumption**: Uses datasets generated by heuristics-v0.03
...
- **Both**: Basic logging → Dataset generation for other extensions
...
- [ ] **File named `agent_bfs.py`** (not `bfs_agent.py`)
...
- [ ] **Multiple architectures** (MLP, CNN, RNN)
