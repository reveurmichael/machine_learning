...
class GameManager:
    ...
    def report_final_statistics(self) -> None:
        ...
        save_session_stats(cast(str, self.log_dir))
    ...
    def increment_round(self, reason: str = "") -> None:
        ...
        game_state.round_manager.start_new_round(getattr(self.game, "apple_position", None))
        ...
        print(Fore.BLUE +
              f"📊 Advanced to round {self.round_count} {f'({reason})' if reason else ''}")
