...
class GreedyAgent:
    """Pick the direction that minimizes Manhattan distance to the apple, avoiding immediate reversal."""

    algorithm_name: str = "GREEDY"

    def get_move(self, game: Any) -> Optional[str]:
        # Expect `game` to expose head_position, apple_position, and get_current_direction_key
