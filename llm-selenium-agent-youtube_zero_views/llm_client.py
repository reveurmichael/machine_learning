...
class LLMClient:
    ...
    def _generate_hunyuan_response(self, prompt: str, **kwargs) -> str:
        ...
        try:
            ...
            # Following the official Tencent example exactly
            client = OpenAI(
            ...
            # Always use a single message without history
            messages = [
                {
                    "role": "user",
                    "content": prompt
            ...
            # Create completion using the exact format from official example
    ...
    def _get_fallback_response(self) -> str:
        ...
        if action == "SEARCH_VIDEOS":
            details = "recently uploaded videos"
