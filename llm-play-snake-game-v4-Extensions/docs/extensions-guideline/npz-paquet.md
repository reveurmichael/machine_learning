...
> **Important — Authoritative Reference:** This document supplements the _Final Decision Series_ (`final-decision-0.md` → `final-decision.md`) and follows established architectural patterns. For data format decisions, see `data-format-decision-guide.md`.
