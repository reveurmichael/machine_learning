"""
Core game data structures and state management.
Handles game state persistence, move tracking, and board representation.
"""
...
class GameData:
    ...
    def reset(self) -> None:
        ...
        self.apple_positions: list[Dict[str, int]] = []
        self.score = 0
        self.steps = 0
        self.game_over = False
        self.game_end_reason: Optional[str] = None
        self.snake_positions: list[list[int]] = []
    ...
    def save_game_summary(self, filepath: str, **kwargs) -> Dict[str, Any]:
        ...
        with open(filepath, "w", encoding="utf-8") as file:
            json.dump(summary_dict, file, cls=NumPyJSONEncoder, indent=4)
        return summary_dict
