...
st.set_page_config(page_title="Supervised v0.03 Runner", page_icon="🧠", layout="wide")

st.title("🧠 Supervised v0.03 Runner")
...
with st.sidebar:
    ...
    model_path: str = st.text_input("Model path (optional)", value="")
