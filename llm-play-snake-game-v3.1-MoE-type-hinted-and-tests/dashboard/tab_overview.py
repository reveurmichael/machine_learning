        ...
        experiments_data.append(
            {
                ...
                "Avg Primary Tokens": int(avg_primary_tokens) if avg_primary_tokens is not None else None,
                ...
                "Avg Secondary Tokens": (
                    int(avg_secondary_tokens) if secondary_provider and avg_secondary_tokens is not None else None
                ),
