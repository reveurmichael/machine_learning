...
def extract_game_summary(summary_file: Union[str, Path]) -> Dict[str, Any]:
    ...
    try:
        ...
        if 'prompt_response_stats' in data:
            ...
            summary['avg_secondary_response_time'] = prompt_stats.get(
            ...
            summary['min_secondary_response_time'] = prompt_stats.get(
                'min_secondary_response_time', 0)
            summary['max_secondary_response_time'] = prompt_stats.get(
                'max_secondary_response_time', 0)
        ...
        print(f"Error extracting summary: {exception}")
