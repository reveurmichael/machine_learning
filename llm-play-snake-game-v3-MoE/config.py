...
MAX_CONSECUTIVE_ERRORS_ALLOWED = 5  # Maximum consecutive errors allowed before game over
...
PROMPT_TEMPLATE_TEXT_SECONDARY_LLM = """You are the secondary LLM in a Mixture-of-Experts system for a Snake game. Your job is to format the primary LLM's output into valid JSON.
...
## RULES:
- "moves" must be a list of directions from: "UP", "DOWN", "LEFT", "RIGHT". You might see "U", "D", "L", "R" in the text, or "North", "South", "West", "East", or other similar words, but you should convert them to "UP", "DOWN", "LEFT", "RIGHT".
