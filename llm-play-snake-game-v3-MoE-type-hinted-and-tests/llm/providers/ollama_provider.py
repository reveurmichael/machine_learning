...
import os
import json
import requests  # type: ignore[import-untyped]  # Install types-requests for full typing support
...
class OllamaProvider(BaseProvider):
    ...
    def generate_response(self, prompt: str, model: Optional[str] = None, **kwargs) -> Tuple[str, Optional[Dict[str, int]]]:
        ...
        try:
            ...
            print(
                f"Making API call to Ollama at http://{server}:11434 with model: {model}, temperature: {temperature}")
