"""
Heuristic Game Logic - A* pathfinding integration
=================================================

This module extends BaseGameLogic to integrate A* pathfinding agents with
the core game mechanics. It demonstrates how heuristic algorithms can be
seamlessly integrated into the base game infrastructure.

Key Features:
- Extends BaseGameLogic with agent integration
- A* pathfinding for move planning with Manhattan distance heuristic
...
class HeuristicGameLogic(BaseGameLogic):
    ...
    def set_agent(self, agent: AStarAgent) -> None:
        """
        Set the A* agent for pathfinding.
