...
from game_manager import RLGameManager  # type: ignore  # noqa: E402

def create_argument_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="RL v0.01 runner")
...
def main() -> None:
    ...
    manager = RLGameManager(gm_args, agent=agent)
    manager.initialize()
    manager.run()
    print_success("RL v0.01 completed")
